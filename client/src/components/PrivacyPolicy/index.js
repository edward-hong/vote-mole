...
const PrivacyPolicy = () => (
	<Container fluid>
		...
		<p>
			Vote Mole ("us", "we", or "our") operates the
			https://vote-mole.herokuapp.com website (the "Service").
		</p>
		...
		<p>
			...
			accessible from https://vote-mole.herokuapp.com
		</p>
		...
		<p>Vote Mole uses the collected data for various purposes:</p>
		<ul>
		...
		<p>
			...
			New Zealand and process it there.
		</p>
		<p>
		...
		<p>
			Vote Mole will take all steps reasonably necessary to ensure that your
		...
		<p>
			Vote Mole may disclose your Personal Data in the good faith belief that
			such action is necessary to:
		</p>
		<ul>
			<li>To comply with a legal obligation</li>
			<li>To protect and defend the rights or property of Vote Mole</li>
			<li>
